...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('welcome', {
    ...
    views: {
      "master": {
        ...
        templateUrl: 'views/welcome.master/welcome.html'
      },
      "fab@welcome":{
        templateUrl: 'views/welcome.fab/fab.html',
        controller: 'FabWelcomeCtrl'
      }
    }
  })
  .state('welcome.signin', {
    ...
    views: {
      "content@welcome": {
        templateUrl: 'views/welcome.signin/signin.html',
  ...
  .state('welcome.signup', {
    ...
    views: {
      "content@welcome": {
        templateUrl: 'views/welcome.signup/signup.html',
