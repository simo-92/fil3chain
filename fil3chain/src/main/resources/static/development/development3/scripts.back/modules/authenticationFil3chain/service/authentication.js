(function() {
  ...
  * Config
  */
  var moduleName = 'service.authentication.fil3chain';
  /**
  * Module
  */
  var module;
  ...
  AuthenticationService.$inject = ['$http', '$cookies', '$rootScope', '$timeout','$q', 'UserService','UserValidatorService'];
  function AuthenticationService($http, $cookies, $rootScope, $timeout, $q, UserService, UserValidatorService) {
    var service = {};
    ...
    function Signin(user) {
      var deferred = $q.defer();
      UserValidatorService.validateUserSignin(user)
      .then(function(user){
