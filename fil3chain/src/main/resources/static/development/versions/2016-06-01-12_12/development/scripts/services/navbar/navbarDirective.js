...
.directive('navbar',['$rootScope','$state','$filter','$mdSidenav','ExactMatchFilter','navbarService', function($rootScope, $state, $filter,$mdSidenav,ExactMatchFilter,navbarService) {
