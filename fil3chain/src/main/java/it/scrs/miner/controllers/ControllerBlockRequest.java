...
public class ControllerBlockRequest {
	...
	/*
	 * @RequestMapping(value = "/generateValidateBlock", method = RequestMethod.GET) public Block generateBlock() {
	 * Block block = new Block("sadsa", "dsadsa", 12, 23, 3); block.generateHashBlock(); return block; }
	 */

	/*
	 * @RequestMapping(value = "/fil3chain/newBlock", method = RequestMethod.GET)
	 * @ResponseBody public Block requestBlock(String hashBlock, String merkleRoot, String creationTime, Integer
	 * minerPublicKey, Integer nonce, Integer chainLevel) { Block block = new Block(hashBlock, merkleRoot, creationTime,
	 * minerPublicKey, nonce, chainLevel); if(block.verify()){ //aggiungerei al db // }
	 */
